...
type FindColorCtrl struct {
	uc *application.FindColor
}

func NewFindIdCircuitoCtrl(uc *application.FindColor) *FindColorCtrl {
	return &FindColorCtrl{uc: uc}
}
...
func (ctrl *FindColorCtrl) Run(c *gin.Context) {
